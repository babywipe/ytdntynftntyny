...
namespace GladiatorMenu
{
	...
	void mainWindow()
	{
		...
		if (ImGui::Begin("Babywipe", &menuOpen, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_ShowBorders | ImGuiWindowFlags_OnlyDragByTitleBar))
		{
			ImGui::BeginGroup();
		...
		{
			if (ImGui::Begin("Babywipe_[DEBUG PARAMETERS]", &g_Options.debug_window, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_ShowBorders))
			{
		...
		ImGui::Columns(2, NULL, false);
		{
			ImGui::BeginChild("COL1", ImVec2(0, 0), true);
			{
				...
				ImGui::Columns(1, NULL, true);
				{
					...
					ImGui::Checkbox("Babywipe Clan-Tag##Other", &g_Options.misc_animated_clantag);
			...
			ImGui::BeginChild("COL2", ImVec2(0, 0), true);
			{
				...
				ImGui::Columns(1, NULL, true);
				{
					...
					if (ImGui::Button("Save##Config"))
					{
						...
						{
							std::string fPath = std::string(Global::my_documents_folder) + "\\babywipe\\" + configItems[configItemCurrent] + ".baby";
					...
					{
						std::string fPath = std::string(Global::my_documents_folder) + "\\babywipe\\" + fName + ".baby";
						Config::Get().SaveConfig(fPath);
